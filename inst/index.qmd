...
intro <- tryCatch(
    {
        description <- packageDescription("BiocBookTesting2")
...
👉 [ghcr.io/lmweber/biocbooktesting2](https://ghcr.io/lmweber/biocbooktesting2) 🐳
...
#| eval: false
docker run -it ghcr.io/lmweber/biocbooktesting2:devel R
```
...
docker run \
    ...
    -e PASSWORD=OHCA \
    -p 8787:8787 \
    ghcr.io/lmweber/biocbooktesting2:devel
```
...
#| eval: false
docker run -it ghcr.io/lmweber/biocbooktesting2:devel bash
